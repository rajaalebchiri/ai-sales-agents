...
function Home({}: Props) {
  return (
    <div className="w-full mx-auto h-full mt-4">
      {" "}
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6 rounded-xl bg-background-10">
        <FeatureSectionLayout
          ...
          link="/lead"
        >
          <div className="p-5 flex flex-col gao-4 items-start border rounded-xl border-border backdrop-blur-3xl">
