...
const MultiStepForm = ({ steps, onComplete }: Props) => {
  ...
  return (
    <div className="flex flex-col justify-center items-cente rounded-2xl overflow-hidden max-w-6xl mx-auto backdrop-blur-[106px]">
      <div className="flex items-center justify-start">
        ...
        <Separator
          ...
          className="data-[orientation-certical:h-1/2"
        />
        <div className="w-full md:w-2/3">
          ...
          >
            ...
            {validationError && (
              <div className="mt-4 p-3 bg-red-900/10 border border-red-800 rounded-md flex items-start gap-2 text-red-700">
